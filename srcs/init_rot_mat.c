...
/*   Updated: 2018/01/09 15:32:26 by snikitin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	fdf->rot_X[4] = cos(fdf->rot_coeff);	
	fdf->rot_X[5] = -sin(fdf->rot_coeff);	
...
{
	fdf->rot_Y[0] = cos(fdf->rot_coeff);	
	fdf->rot_Y[2] = sin(fdf->rot_coeff);	
...
{
	fdf->rot_Z[0] = cos(fdf->rot_coeff);	
	fdf->rot_Z[1] = -sin(fdf->rot_coeff);	
